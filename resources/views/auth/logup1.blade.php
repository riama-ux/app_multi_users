            ...
            <div class="row">
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="h3 text-primary pt-5">Inscription</div>

                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <form action="{{ route('auth.postLogup') }}" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="form-label">Nom d'utilisateur</label>
                                            <input class="form-control form-control-lg @error('name') is-invalid @enderror" type="text" name="name" placeholder="Entrez votre Prénom et Nom" value="{{ old('name') }}" required autocomplete="name" />
                                            @error('name')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="password" name="password_confirmation" placeholder="Rétapez votre Mot de passe" />
                                        </div>
