        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="{{ request()->is('manager') ? 'sidebar-item active' : 'sidebar-item' }}">
                        <a class="sidebar-link" href="{{ route('manager.home') }}">
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('manager.user.edit', encrypt(Auth::user()->id)) }}"><i class="align-middle me-1" data-feather="user"></i> Mon Compte</a>
